            ...
            <View className="mx-5 mt-5 relative">
                ...
                <View className="flex flex-col xl:flex-row justify-between w-full">
                    <View>
                        ...
                        <View className="my-4">
                            <CustomTextInput value={firstName} setValue={setFirstName} label="First Name" />
                            <CustomTextInput value={lastName} setValue={setLastName} label="Last Name" />
                            ...
                            <SmallBtn handleClick={() => updatePassword()} active={!updatingProfile} customStyles="mt-2 bg-turqoise">{updatingProfile ? 'Processing...' : 'Change Password'}</SmallBtn>
                        </View>
                    </View>
                    ...
                    <BigBtn 
                        customStyles="bg-white border-2 border-solid border-black mb-7"
                ...
                <BigBtn handleClick={() => updateProfile()} active={!updatingProfile} customStyles="my-8">{updatingProfile ? 'Processing...' : 'Update Profile'}</BigBtn>
            </View>
        </ScrollView>
    )
}
