...
export default function ProfileBox() {
    ...
    return (
        <>
            { isProfileBoxOpen && (
                <View className='w-64 absolute top-4 right-4 pb-4 opacity-100 bg-white border-2 border-solid border-black rounded-3xl layer z-50'>
                    ...
                    <View className="ml-4 mt-4">
                        ...
                        <View className="flex flex-col mt-5 mr-4">
                            ...
                            <SmallBtn handleClick={() => router.replace('/')} customStyles={'mt-3'} whiteBtn>View Profile</SmallBtn>
                        </View>
                    </View>
                </View> )}
        </> 
